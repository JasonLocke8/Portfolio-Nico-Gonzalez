...
const About: React.FC = () => {
  return (
    <section id="sobre-mí" className="py-20 bg-white dark:bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 animate-on-scroll">
            <img
              src="https://i.imgur.com/3mhsLeC.png"
              alt="Nico Gonzalez"
          ...
          <div className="md:w-1/2 md:pl-12 animate-on-scroll">
            <p className="text-lg mb-6 leading-relaxed">
              Hola, mi nombre es <span className="font-semibold text-blue-600 dark:text-blue-400">Nicolás González</span>, un desarrollador web apasionado por crear experiencias digitales únicas y funcionales. Entre las tecnologías que manejo están HTML, CSS, JavaScript, C#, Java y SQL. Disfruto trabajando en proyectos desafiantes que me permitan aprender y crecer profesionalmente.
            </p>
